  ...
  const shareLinks = [
    {
      ...
      color:
        "text-gray-500 dark:text-gray-300 hover:text-[#1877F2] hover:border-[#1877F2]",
    ...
    },
    {
      ...
      color:
        "text-gray-500 dark:text-gray-300 hover:text-black hover:border-black",
    ...
    },
    {
      ...
      color:
        "text-gray-500 dark:text-gray-300 hover:text-[#25D366] hover:border-[#25D366]",
        ...
        <div className="flex items-center gap-2">
          {shareLinks.map((link) => (
            <a
              ...
              className={`w-9 h-9 rounded-full border border-slate-300 dark:border-slate-700 bg-transparent flex items-center justify-center transition-all duration-300 hover:-translate-y-1 transform ${link.color}`}
              title={link.name}
            >
              {link.icon}
            </a>
          ...
          <button
            onClick={handleCopy}
            className={`group relative flex items-center justify-center w-9 h-9 rounded-full border border-slate-300 dark:border-slate-700 bg-white dark:bg-[#1e1e1e] text-gray-500 dark:text-gray-300 shadow-sm transition-all duration-300 hover:border-primary hover:text-primary ${
              copied ? "bg-primary border-primary text-white" : ""
            }`}
